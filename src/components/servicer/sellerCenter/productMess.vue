		...
		<div class="g-content">
			...
			<el-form :model="pulishForm" :rules="storeRules" ref="pulishForm">
				...
				<el-form-item label="商品标题" prop="product_name">
					<el-input v-model="pulishForm.product_name" placeholder="最多可输入30个字" class="login-input2 product_name" style="width: 320px;">
					</el-input>
				</el-form-item>
				...
				<el-form-item label="商品分类" prop="mall_categorys">
					<checkMallClassify :mall_categorys="pulishForm.mall_categorys" @mallCategorys="mallCategorys" class="scrollbar">
					</checkMallClassify>
				</el-form-item>
			...
			<div class="parentMess" v-if="editShow==='编辑商品'?true:false">
				{{parentMess}}
			</div>
		</div>
		<!--............各种类型按钮.........-->
