  ...
  <div class="adForm clearfix">
    <div class="adForm-con clearfix mb-20">
      ...
      <div class="adForm-right ">
        <div v-if="formData.click_style==1" class="adForm-right_one">
          <imageUpload :imageUrl="formImage[1]" imageType="mall" @getImageUrl="oneUploadImg">
          </imageUpload>
          <p class="f12 color-7F">图片尺寸宽度建议750px，格式支持png,jpg</p>
          <el-form label-width="100px" :model="styleOne">
            <el-form-item label="姓名:">
              <el-input v-model="styleOne.name" placeholder="请输入姓名">
              </el-input>
            </el-form-item>
            <el-form-item label="手机号:">
              <el-input v-model="styleOne.phone" placeholder="请输入手机号">
              </el-input>
            </el-form-item>
            <el-form-item label="QQ:">
              <el-input v-model="styleOne.qq" placeholder="请输入微信号/QQ">
              </el-input>
            </el-form-item>
          </el-form>
        </div>
        <div v-if="formData.click_style==2" class="adForm-right_two">
          <imageUpload :imageUrl="formImage[2]" imageType="mall" @getImageUrl="twoUploadImg">
          </imageUpload>
          <el-form label-width="100px" :model="styleTwo">
            <el-form-item label="姓名:">
              <el-input v-model="styleTwo.name" placeholder="请输入姓名">
              </el-input>
            </el-form-item>
            <el-form-item label="手机号:">
              <el-input v-model="styleTwo.phone" placeholder="请输入手机号">
              </el-input>
            </el-form-item>
            <el-form-item label="QQ:">
              <el-input v-model="styleTwo.qq" placeholder="请输入微信号/QQ">
              </el-input>
            </el-form-item>
          </el-form>
          <p class="f12 color-7F">图片尺寸宽度建议750px，格式支持png,jpg</p>
    ...
    <div class="pagination-r clearfix float-r pb-20">
  ...
  export default {
    ...
    methods: {
      ...
      sureForm() { //表单确定按钮
        ...
        let formMess = {
          click_type: "form",
          click_style: this.formData.click_style,
          click_image_url: form_url
        };
        this.$emit("shop_hidden", false);
