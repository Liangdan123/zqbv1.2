<template>
	<div class="allOrder commodity" @click="closeSearch">
		...
		<div class="g-content">
			...
			<!--........................表格...............-->
			<bought :orderData="orderData" :orderMess="orderMess" @handleCurrent="handleCurrent" @showOrder="showOrder" :isShopName="true" 
				@showSetOrder="showSetOrder"  @showlogist="showlogist" :orderLists="orderLists" v-loading="loading">
