  ...
  <div class="platform commodity" @click="closeSearch">
    ...
    <div class="g-content">
      ...
      <div class="buttons clearfix mb-20">
        ...
        <search :search.sync="searchCondition.search" @searchMethod="searchMethod" @emptyMthod='searchMethod' ref="isShow" inputSearch='order_search'
          selectTitle='筛选条件' hintMess="输入相关信息进行搜索">
        </search>
      </div>
      <!--........................表格...............-->
