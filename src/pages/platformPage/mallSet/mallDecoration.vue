  ...
  <div class="mallDecoration">
    <div class="mallDecor_middle" v-loading="mallSetMiddle">
      ...
      <div class="mallPlate" v-for="(item,index) in correscomList" :key="index">
        <!--..................轮播海报一....................-->
        <div v-if="item.component_key==='hbys1'" class="pos-r bg-f mt-10">
          <!--..................当有数据时执行这里....................-->
          <div v-if="item.data">
        ...
        <!--..................图片导航....................-->
        <div v-if="item.component_key==='tpdh'" class="cursor pos-r mt-10 tpdh" @click="isShowPlate(index)" :class="index_plate===index?'border_b':errorPlate.tpdh && index===errorIndex?'border-red':''">
          <!--..................当有数据时执行这里....................-->
          <div v-if="item.data && txtImgSelect===false" class="clearfix imgNavCon">
        ...
        <div v-if="item.component_key==='splb3'&&shopNum!==0" class="cursor pos-r mt-10 splb3" @click="isShowPlate(index)"
          ...
          <div v-if="item.list.length===0" class="clearfix">
            <div v-for="item in threeRow" class="float-l pl-15">
              <b class="mt-15 display-b" style="height: 105px; width: 105px; background-color: #E5F5FF;">
              </b>
          ...
          <!--....................右边.................-->
          <mallDecora v-if="index===index_plate" :mallPlate='item' :shopNum="shopNum">
          </mallDecora>
        </div>
        <!--..................商品列表....................-->
        <div v-if="item.component_key==='splb1'" class="cursor pos-r bg-f mt-10 splb1" @click="isShowPlate(index)"
        ...
        <!--..................商品双列....................-->
        <div v-if="item.component_key==='splb2'" class="cursor pos-r mt-10 splb2" @click="isShowPlate(index)" :class="index_plate===index?'border_b':errorPlate.splb2 && index===errorIndex?'border-red':''">
          <h2 class="f16 color-3 text-c font-n line" v-if="item.data.title_switch==='on'">
            <i class="verticalLine"></i> {{!item.data.title?"模块标题":item.data.title}}
          </h2>
          <!--...................当商品搜索出来有数据时或者是商品已发布时....................-->
        ...
        <!--..................轮播海报二....................-->
        <div v-if="item.component_key==='hbys2'" class=" pos-r bg-f mt-10 hbys2">
        ...
        <!--..................店铺列表....................-->
        <div v-if="item.component_key==='dplb1'" class="cursor pos-r bg-f mt-10 dplb1" @click="isShowPlate(index)"
