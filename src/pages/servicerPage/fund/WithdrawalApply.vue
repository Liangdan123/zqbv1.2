       ...
       <div class="g-content">
            ...
            <el-form
                ...
                <el-form-item label="姓名："
                	prop="tixian_name"
                	v-if="withdrawalApplyData.tixian_type===1||withdrawalApplyData.tixian_type===2"
                	:rules="{
                ...
                <el-form-item label="银行卡号" 
                    ...
                    <el-input
                        ...
                        v-model.number="withdrawalApplyData.tixian_account">
                    </el-input>
                </el-form-item>
               
               	<el-form-item label="账户："
               		prop="tixian_account"
               		v-if="withdrawalApplyData.tixian_type===1"
               		:rules="{
				...
				<el-form-item label="微信号："
               		prop="tixian_account"
               		v-if="withdrawalApplyData.tixian_type===2"
               		:rules="{
                		required:true,message: '账户不能为空', trigger: 'blur'
                	}">
               		<el-input
...
<script>
	import {getVerifyCode,withdrawalApplyCommit,getAccountMoney} from "@/api/servicer"
	export default{
