  ...
  <div class="wrap">
    ...
    <div class="container">
      ...
      <el-table class="table" v-loading="tableDataLoading" :data="filterResults" style="width: 100%">
        <el-table-column prop="contact_name" label="申请人">
        </el-table-column>
        <el-table-column prop="contact_phone" label="联系方式">
        </el-table-column>
        <el-table-column prop="commit_time" label="申请时间">
        </el-table-column>
      ...
      <el-dialog title="商家入驻申请" :visible.sync="dialogVisible" :before-close="handleClose">
        <div v-loading="dialogDataLoading" class="dialog-content">
        ...
        <span v-if="applyInfo.auth_status==0" slot="footer" class="dialog-footer">
          <el-button @click="shopEntryAudit(1)" :loading="btnLoadingIndex==1" :disabled="btnDisabled" class="btn-agree" type="primary">
            同意申请
          </el-button>
          <el-button @click="shopEntryAudit(2)" :disabled="btnDisabled" :loading="btnLoadingIndex==2" class="btn-reject">
            拒绝申请
          </el-button>
        </span>
      </el-dialog>
